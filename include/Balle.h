...
void updateSpatialLookup(std::vector<Balle> &balles, float radius, int numParticles, std::unordered_map<int, unsigned int> &spatialLookup, std::vector<unsigned int> &startIndices);
